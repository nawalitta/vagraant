 ...
 */
class TypeActivite extends \ActiviteBundle\Entity\TypeActivite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ActiviteBundle\\Entity\\TypeActivite' . "\0" . 'id', '' . "\0" . 'ActiviteBundle\\Entity\\TypeActivite' . "\0" . 'designation', '' . "\0" . 'ActiviteBundle\\Entity\\TypeActivite' . "\0" . 'activites'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeActivite $proxy) {
