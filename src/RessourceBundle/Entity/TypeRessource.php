...
class TypeRessource
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="BesoinTypeRessource", mappedBy="typeRessource",cascade={"persist"})
     */
    private $besoinsTypeRessources;

    /**
     * @ORM\OneToMany(targetEntity="Ressource", mappedBy="typeRessource",cascade={"persist"})
     */
    private $ressources;
