 ...
 */
class ActiviteFixee extends \ActiviteBundle\Entity\ActiviteFixee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ActiviteBundle\\Entity\\ActiviteFixee' . "\0" . 'id', '' . "\0" . 'ActiviteBundle\\Entity\\ActiviteFixee' . "\0" . 'heureDebut', '' . "\0" . 'ActiviteBundle\\Entity\\ActiviteFixee' . "\0" . 'heureFin', '' . "\0" . 'ActiviteBundle\\Entity\\ActiviteFixee' . "\0" . 'jour', '' . "\0" . 'ActiviteBundle\\Entity\\ActiviteFixee' . "\0" . 'enfant', '' . "\0" . 'ActiviteBundle\\Entity\\ActiviteFixee' . "\0" . 'activite'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ActiviteFixee $proxy) {
    ...
    public function isHeureValid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isHeureValid', []);

        return parent::isHeureValid();
    }
