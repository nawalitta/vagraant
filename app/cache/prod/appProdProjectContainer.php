...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'gpac', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\RessourceBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ActiviteBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\UtilisateurBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\CalendarBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'RessourceBundle\\Entity');
        $c->addDriver($b, 'ActiviteBundle\\Entity');
        $c->addDriver($b, 'UtilisateurBundle\\Entity');
        $c->addDriver($b, 'CalendarBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('RessourceBundle' => 'RessourceBundle\\Entity', 'ActiviteBundle' => 'ActiviteBundle\\Entity', 'UtilisateurBundle' => 'UtilisateurBundle\\Entity', 'ADesignsCalendarBundle' => 'CalendarBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_561d90d9663cdab7032bdf67bc726987ada5405fbcfebac87d8092001b6e6aed');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig'), 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CalendarBundle/Resources/views'), 'ADesignsCalendar');
        $instance->addPath(($this->targetDirs[3].'\\src\\StatsBundle/Resources/views'), 'Stats');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6d719eec63b86c61da9d7c9ea94e44e2be5040ad');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('589cd14c46cf36.90676064')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ADesignsCalendarBundle' => 'CalendarBundle\\ADesignsCalendarBundle',
                'StatsBundle' => 'StatsBundle\\StatsBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'RessourceBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\RessourceBundle'),
                    'namespace' => 'RessourceBundle',
                ),
                ...
                'ADesignsCalendarBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\CalendarBundle'),
                    'namespace' => 'CalendarBundle',
                ),
                'StatsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\StatsBundle'),
            ...
            'secret' => '6d719eec63b86c61da9d7c9ea94e44e2be5040ad',
            'locale' => 'en',
            ...
            'kernel.secret' => '6d719eec63b86c61da9d7c9ea94e44e2be5040ad',
