...
class EnfantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $enfants = $em->getRepository('RessourceBundle:Enfant')->findAll();
    ...
    {
        $enfant = new Enfant();
        $form = $this->createForm('RessourceBundle\Form\EnfantType', $enfant);
        ...
        return $this->render('RessourceBundle:Enfant:new.html.twig', array(
            'enfant' => $enfant,
    ...
    {
        $deleteForm = $this->createDeleteForm($enfant);
        $editForm = $this->createForm('RessourceBundle\Form\EnfantType', $enfant);
