 ...
 */
class Preaffection extends \RessourceBundle\Entity\Preaffection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RessourceBundle\\Entity\\Preaffection' . "\0" . 'id', '' . "\0" . 'RessourceBundle\\Entity\\Preaffection' . "\0" . 'enfant', '' . "\0" . 'RessourceBundle\\Entity\\Preaffection' . "\0" . 'activite', '' . "\0" . 'RessourceBundle\\Entity\\Preaffection' . "\0" . 'ressource'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Preaffection $proxy) {
    ...
    public function setRessource(\RessourceBundle\Entity\Ressource $ressource)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRessource', [$ressource]);
